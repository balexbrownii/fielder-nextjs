...
export const CALIFORNIA_REGIONS: Record<string, GrowingRegionExtended> = {
  ...
  central_coast_south: {
    ...
    notes: 'Year-round production. Strong farm-to-table movement'
  },
  napa_valley: {
    id: 'napa_valley',
    name: 'Napa Valley',
...
export const FLORIDA_REGIONS: Record<string, GrowingRegionExtended> = {
  indian_river: {
    ...
    notes: '200-mile coastal strip. World-renowned Indian River citrus. 5-gen family operations'
  },
  plant_city: {
    id: 'plant_city',
  ...
  homestead_redland: {
    ...
    notes: 'Unique oolitic limestone soil. One of few continental US tropical regions'
  },
  central_florida_citrus: {
    ...
    notes: '5 counties produce 71% of FL citrus. 88% oranges'
  },
  florida_panhandle: {
...
export const GEORGIA_REGIONS: Record<string, GrowingRegionExtended> = {
  ...
  georgia_peach_belt: {
    id: 'georgia_peach_belt',
    name: 'Georgia Peach Belt',
    displayName: 'Georgia Peach Belt',
    slug: 'fort-valley-ga',
    state: 'GA',
    macroRegion: 'southeast',
    counties: ['Macon', 'Peach', 'Crawford', 'Taylor'],
    primaryCities: ['Fort Valley', 'Byron', 'Musella', 'Butler'],
    latitude: 32.6,
    longitude: -83.9,
    dtcActivity: 'high',
    primaryProducts: ['peaches', 'pecans'],
  ...
  south_georgia_pecan: {
    id: 'south_georgia_pecan',
    name: 'South Georgia Pecan Belt',
    displayName: 'South Georgia Pecans',
    slug: 'albany-ga',
    state: 'GA',
    macroRegion: 'southeast',
    counties: ['Mitchell', 'Dougherty', 'Macon', 'Lee', 'Houston'],
    primaryCities: ['Albany', 'Camilla', 'Moultrie'],
    latitude: 31.6,
    longitude: -84.2,
    dtcActivity: 'medium',
    ...
    notes: '170,000+ acres. 33% of US production. 88M lbs average harvest'
  },
  atlanta_metro: {
    id: 'atlanta_metro',
    name: 'Atlanta Metro Urban Agriculture',
    displayName: 'Atlanta Metro',
    slug: 'atlanta-ga',
    state: 'GA',
    macroRegion: 'southeast',
    counties: ['Fulton', 'DeKalb', 'Cobb', 'Gwinnett', 'Clayton'],
    primaryCities: ['Atlanta', 'College Park', 'Decatur'],
    latitude: 33.7,
    longitude: -84.4,
    dtcActivity: 'high',
    primaryProducts: ['vegetables', 'herbs', 'fruits'],
    climate: { avgLastFrostDoy: 85, avgFirstFrostDoy: 315, frostFreeDays: 230, annualGdd50: 3700, avgChillHours: 650, usdaZone: '8' },
    notes: '300+ community gardens, 50 urban farms. Strong food access focus'
  }
}
...
export const CAROLINAS_REGIONS: Record<string, GrowingRegionExtended> = {
  sc_peach_ridge: {
    ...
    state: 'SC',
    macroRegion: 'southeast',
    counties: ['Saluda', 'Aiken', 'Edgefield'],
    primaryCities: ['Ridge Spring', 'Monetta'],
    latitude: 33.8,
    longitude: -81.7,
    dtcActivity: 'high',
    primaryProducts: ['peaches', 'pecans'],
  ...
  nc_sweet_potato: {
    id: 'nc_sweet_potato',
    name: 'Eastern NC Sweet Potato Region',
    displayName: 'NC Sweet Potato Belt',
    slug: 'wilson-nc',
    state: 'NC',
    macroRegion: 'southeast',
    counties: ['Johnston', 'Nash', 'Edgecombe', 'Sampson', 'Wilson', 'Columbus', 'Cumberland'],
    primaryCities: ['Smithfield', 'Wilson', 'Nashville', 'Clinton'],
    latitude: 35.6,
    longitude: -78.1,
    dtcActivity: 'medium',
    primaryProducts: ['sweet_potatoes', 'tobacco', 'soybeans', 'peanuts'],
...
export const TEXAS_REGIONS: Record<string, GrowingRegionExtended> = {
  ...
  dallas_fort_worth: {
    ...
    state: 'TX',
    macroRegion: 'southwest',
    counties: ['Denton', 'Collin', 'Tarrant', 'Dallas', 'Rockwall', 'Kaufman'],
    primaryCities: ['Dallas', 'Fort Worth', 'Plano', 'McKinney', 'Frisco'],
    latitude: 32.8,
    longitude: -96.8,
    dtcActivity: 'high',
    primaryProducts: ['vegetables', 'berries', 'eggs', 'grass_fed_meats'],
    climate: { avgLastFrostDoy: 80, avgFirstFrostDoy: 320, frostFreeDays: 240, annualGdd50: 4100, avgChillHours: 600, usdaZone: '8' },
    notes: '910,000 acres ag land. 150+ farmers markets. Strong urban farming'
  },
  austin_metro: {
    id: 'austin_metro',
    name: 'Austin Metro Area',
    displayName: 'Austin Metro',
    slug: 'austin-tx',
    state: 'TX',
    macroRegion: 'southwest',
    counties: ['Travis', 'Hays', 'Williamson', 'Bastrop'],
    primaryCities: ['Austin', 'Cedar Park', 'Round Rock'],
    latitude: 30.3,
    longitude: -97.7,
    dtcActivity: 'high',
    primaryProducts: ['vegetables', 'fruits', 'grass_fed_meats', 'eggs', 'dairy'],
...
export const SW_DESERT_REGIONS: Record<string, GrowingRegionExtended> = {
  ...
  albuquerque_metro: {
    id: 'albuquerque_metro',
    name: 'Albuquerque Metro Area',
    displayName: 'Albuquerque Metro',
    slug: 'albuquerque-nm',
    state: 'NM',
    macroRegion: 'southwest',
    counties: ['Bernalillo', 'Sandoval', 'Valencia'],
    primaryCities: ['Albuquerque', 'Rio Rancho', 'Los Ranchos'],
    latitude: 35.1,
    longitude: -106.6,
    dtcActivity: 'high',
    primaryProducts: ['vegetables', 'fruits', 'chile', 'herbs'],
    climate: { avgLastFrostDoy: 100, avgFirstFrostDoy: 295, frostFreeDays: 195, annualGdd50: 3600, avgChillHours: 700, usdaZone: '7' },
    notes: 'Rail Yards Market: 400+ vendors. $150K+ in SNAP benefits distributed'
  },
  northern_nm: {
    id: 'northern_nm',
  ...
  phoenix_metro: {
    id: 'phoenix_metro',
    name: 'Phoenix Metro',
    displayName: 'Phoenix Metro',
    slug: 'phoenix-az',
    state: 'AZ',
    macroRegion: 'southwest',
    counties: ['Maricopa'],
    primaryCities: ['Phoenix', 'Scottsdale', 'Gilbert', 'Tempe', 'Mesa'],
    latitude: 33.4,
    longitude: -112.1,
    dtcActivity: 'high',
    primaryProducts: ['vegetables', 'fruits', 'grass_fed_beef', 'eggs'],
    climate: { avgLastFrostDoy: 40, avgFirstFrostDoy: 345, frostFreeDays: 305, annualGdd50: 6500, avgChillHours: 150, usdaZone: '10' },
    notes: 'Uptown Farmers Market: 150+ vendors (largest in AZ). Year-round growing'
  },
  tucson_metro: {
    id: 'tucson_metro',
    name: 'Tucson Metro',
    displayName: 'Tucson Metro',
    slug: 'tucson-az',
    state: 'AZ',
    macroRegion: 'southwest',
    counties: ['Pima'],
    primaryCities: ['Tucson', 'Oro Valley', 'Marana'],
    latitude: 32.2,
    longitude: -110.9,
    dtcActivity: 'high',
...
export const MIDWEST_REGIONS: Record<string, GrowingRegionExtended> = {
  nw_michigan_cherry: {
    id: 'nw_michigan_cherry',
    name: 'Northwest Michigan Cherry Belt',
    displayName: 'Traverse City',
    slug: 'traverse-city-mi',
    state: 'MI',
    macroRegion: 'midwest',
    counties: ['Grand Traverse', 'Leelanau', 'Benzie', 'Antrim', 'Emmet'],
    primaryCities: ['Traverse City', 'Petoskey', 'Charlevoix'],
    latitude: 44.8,
    longitude: -85.6,
    dtcActivity: 'high',
  ...
  sw_michigan_fruit: {
    id: 'sw_michigan_fruit',
    name: 'Southwest Michigan Fruit Belt',
    displayName: 'SW Michigan',
    slug: 'south-haven-mi',
    state: 'MI',
    macroRegion: 'midwest',
    counties: ['Van Buren', 'Allegan', 'Berrien', 'Kalamazoo', 'St. Joseph'],
    primaryCities: ['South Haven', 'Benton Harbor', 'Kalamazoo'],
    latitude: 42.4,
    longitude: -86.3,
    dtcActivity: 'high',
    primaryProducts: ['blueberries', 'peaches', 'grapes', 'apples', 'vegetables'],
  ...
  columbus_metro: {
    id: 'columbus_metro',
    name: 'Central Ohio/Columbus Metro',
    displayName: 'Columbus Metro',
    slug: 'columbus-oh',
    state: 'OH',
    macroRegion: 'midwest',
    counties: ['Franklin', 'Delaware', 'Fairfield', 'Pickaway', 'Madison'],
    primaryCities: ['Columbus', 'Dublin', 'Westerville'],
    latitude: 40.0,
    longitude: -83.0,
    dtcActivity: 'high',
    primaryProducts: ['vegetables', 'fruits', 'honey', 'eggs', 'meats'],
  ...
  indianapolis_metro: {
    ...
    displayName: 'Indianapolis Metro',
    slug: 'indianapolis-in',
    state: 'IN',
    macroRegion: 'midwest',
    counties: ['Marion', 'Hamilton', 'Hendricks', 'Johnson', 'Hancock', 'Boone'],
    primaryCities: ['Indianapolis', 'Carmel', 'Fishers', 'Noblesville'],
    latitude: 39.8,
    longitude: -86.2,
    dtcActivity: 'high',
    primaryProducts: ['vegetables', 'eggs', 'poultry', 'grass_fed_meats'],
  ...
  chicago_metro: {
    id: 'chicago_metro',
    name: 'Chicago Metro/Urban Farms',
    displayName: 'Chicago Metro',
    slug: 'chicago-il',
    state: 'IL',
    macroRegion: 'midwest',
    counties: ['Cook', 'DuPage', 'Lake', 'Will'],
    primaryCities: ['Chicago', 'Naperville', 'Aurora', 'Evanston'],
    latitude: 41.9,
    longitude: -87.6,
    dtcActivity: 'high',
    primaryProducts: ['vegetables', 'herbs', 'microgreens', 'fruits'],
    climate: { avgLastFrostDoy: 120, avgFirstFrostDoy: 285, frostFreeDays: 165, annualGdd50: 2700, avgChillHours: 1100, usdaZone: '5' },
    notes: 'Urban Growers Collective. Strong CSA culture. Link Up doubles SNAP'
  },
  twin_cities_metro: {
    id: 'twin_cities_metro',
    name: 'Twin Cities Metro',
    displayName: 'Twin Cities',
    slug: 'minneapolis-mn',
    state: 'MN',
    macroRegion: 'midwest',
    counties: ['Hennepin', 'Ramsey', 'Dakota', 'Anoka', 'Washington', 'Carver'],
    primaryCities: ['Minneapolis', 'St. Paul', 'Bloomington'],
    latitude: 44.9,
    longitude: -93.3,
    dtcActivity: 'high',
    primaryProducts: ['vegetables', 'fruits', 'berries', 'grass_fed_meats'],
    climate: { avgLastFrostDoy: 130, avgFirstFrostDoy: 275, frostFreeDays: 145, annualGdd50: 2500, avgChillHours: 1350, usdaZone: '4' },
    notes: 'Strong CSA culture. 700+ certified organic farms statewide'
  },
  minnesota_apples: {
    id: 'minnesota_apples',
...
const LEGACY_ALIASES: Record<string, string> = {
  ...
  // Georgia
  georgia_piedmont: 'georgia_peach_belt',
  // Texas - these already match
  // texas_rgv, texas_hill_country, texas_pecan_belt
  // Michigan
  michigan_west: 'nw_michigan_cherry',
  michigan_southwest: 'sw_michigan_fruit',
  // Wisconsin
  ...
  // South Carolina
  south_carolina_ridge: 'sc_peach_ridge',
}
